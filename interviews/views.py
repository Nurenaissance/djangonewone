...
def public_interview_submit(request):
    ...
    try:
        ...
        def _resolve_file_meta(uploaded_file):
            """Resolve file extension + content type for upload"""
        ...
        calibration_ext, calibration_ct = _resolve_file_meta(calibration_audio_file)
        part1_ext, part1_ct = _resolve_file_meta(part1_audio_file)
        part2_ext, part2_ct = _resolve_file_meta(part2_audio_file)
        ...
        cache.delete("interview_stats_ehgymjv_itype_vidushi_maan_vidushi")
