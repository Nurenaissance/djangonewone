-- ==================================================================================
-- COMPLETE ANALYTICS TABLES MIGRATION FOR AZURE POSTGRESQL
-- ==================================================================================
-- This script creates ALL analytics tables needed for the WhatsApp bot server
-- Run this in Azure Portal Query Editor for your PostgreSQL database
-- ==================================================================================
...
-- Real-time hourly aggregations (THIS WAS MISSING!)
...
DROP TRIGGER IF EXISTS update_template_analytics_daily_updated_at ON template_analytics_daily;
...
SELECT
    ...
    table_name,
    (SELECT COUNT(*) FROM information_schema.tables WHERE information_schema.tables.table_name = t.table_name) as exists
FROM (
    SELECT 'message_events' as table_name
    UNION ALL SELECT 'button_clicks'
    UNION ALL SELECT 'template_analytics_daily'
    UNION ALL SELECT 'campaign_analytics'
    UNION ALL SELECT 'hourly_analytics'
) t
ORDER BY table_name;
...
-- ==================== SUCCESS MESSAGE ====================
SELECT '✅ All analytics tables created successfully!' as message;
