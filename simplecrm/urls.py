...
urlpatterns = [
    ...
    path('forgot-password/', Reg.forgot_password, name='forgot-password'),
    path('reset-password/', Reg.reset_password, name='reset-password'),
    path('force-password-reset/', Reg.force_password_reset, name='force-password-reset'),
    ...
    path('users/<int:user_id>/update-phone/', getuser.update_user_phone_number, name='update-user-phone'),
    path('flows/<int:node_template_id>/', nviews.NodeTemplateFlowView.as_view(), name='get_node_template_flow'),
