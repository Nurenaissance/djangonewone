...
export async function saveMessage(userPhoneNumber, business_phone_number_id, formattedConversation, tenant, timestamp, retryCount = 0) {
    const MAX_RETRIES = 3;
    ...
    try {
        ...
        if (isRetryable && retryCount < MAX_RETRIES) {
            ...
            return saveMessage(userPhoneNumber, business_phone_number_id, formattedConversation, tenant, timestamp, retryCount + 1);
        }
